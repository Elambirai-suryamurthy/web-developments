...
<body>
    ...
    <div class="container box">
        ...
        <form action="index.php" method="post" name="form" class="bg-light pure-form" onsubmit="return validation()">
            ...
            <button type="submit" class="btn btn-success pure-button pure-button-primary" name="but">Submit</button><br>
            <a href="login.html" style="position: absolute;left: 150px;top:405px;">already have account?</a>
        </form>
    </div>
    <script>
